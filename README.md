...
DDR4 Baiyang-V0.9 代码已在FPGA部署且经过SPEC CPU2006 基准测试（ref, int+float）Full Trace 满速压力测试，最新版本已在帕拉丁集成香山昆明湖-v2核测试，基于SPEC CPU2006 基准测试（ref, int+float）跑分评估可达 14分/GHz，接近商用MC IP性能水平，该版本拟于2026年春节前后开源。
