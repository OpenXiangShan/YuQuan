...
class mc_top extends RawModule {
    ...
    withClockAndReset (io.clk, io.rst) {
        ...
        // filter
        u_axi_top.io.ui_awio                                    <> u_filter.io.wcmd
        u_axi_top.io.ui_wio                                     <> u_filter.io.wdata
        ...
        // addrmap
        u_filter.io.wcmd_addrmap                                <>  u_addr_map.io.WrCmdFromFilter
        u_filter.io.waddr_data                                  <>  u_addr_map.io.WrDataFromFilter
        ...
        //GWDB
        u_gwdb.io.calDone                                       := apbslv.io.apbDone & io.phy_cal_done
        ...
        //advanced scheduler 
        u_scheduler.io.cmdIn(1).filterCmd                       :<>= u_gwdb.io.AddrmapCmd2AS
        u_scheduler.io.cmdIn(0).filterCmd                       :<>= u_addr_map.io.RdCmd2AS
        u_scheduler.io.cmdIn(1).cacheCmd                        :<>= u_gwdb.io.CacheCmd2AS
        u_scheduler.io.cmdIn(0).cacheCmd                        :<>= u_cache.io.RdCmd2AS  
        ...
        u_scg.io.calDone                                        :=  apbslv.io.apbDone & io.phy_cal_done
